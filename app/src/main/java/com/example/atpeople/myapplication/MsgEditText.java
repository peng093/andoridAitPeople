...
public class MsgEditText extends AppCompatEditText {
    ...
    //生成一个需要整体删除的Span
    private void makeSpan(Spannable sps, UnSpanText unSpanText, final String userId) {
        ...
        ClickableSpan clickableSpan = new ClickableSpan() {
            ...
            public void onClick(View widget) {
                Toast.makeText(MainActivity.instance, "id:"+userId, Toast.LENGTH_SHORT).show();
            }
        };
        sps.setSpan(clickableSpan,start, end, Spannable.SPAN_EXCLUSIVE_EXCLUSIVE);
    }
