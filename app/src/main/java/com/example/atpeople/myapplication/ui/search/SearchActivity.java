package com.example.atpeople.myapplication.ui.search;
...
public class SearchActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adapter_helper);
    ...
    @OnClick({R.id.iv_titlebar_left, R.id.iv_search, R.id.tv_clear,R.id.tv_select})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_clear:
                ...
                break;
            case R.id.tv_select:
                tv_select.setSelected(!tv_select.isSelected());
                break;
        }
    }
